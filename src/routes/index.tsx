    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
          ...
          <nav className="hidden items-center gap-8 text-sm text-muted-foreground md:flex">
            ...
            <a href="#sectores" className="hover:text-foreground">
              Sectores
            </a>
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="mt-6 font-display text-4xl font-extrabold tracking-tight sm:text-6xl">
              Gestiona tus citas, clientes y servicios{" "}
              <span className="bg-gradient-to-r from-primary to-chart-5 bg-clip-text text-transparent">
                sin complicaciones
              </span>
            </h1>
            <p className="mx-auto mt-5 max-w-2xl text-balance text-base text-muted-foreground sm:text-lg">
              Citaflex es la plataforma todo en uno para barberías, salones, profesionales de la
              salud y cualquier negocio que trabaje con citas.
            </p>
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link
                to="/app"
                className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/20 hover:bg-primary/90 sm:w-auto"
              >
                Empezar gratis <ArrowRight className="h-4 w-4" />
              </Link>
              <a
                href="#features"
                className="inline-flex w-full items-center justify-center rounded-lg border border-border bg-card px-6 py-3 text-sm font-semibold hover:bg-accent sm:w-auto"
              >
                Ver cómo funciona
              </a>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4">
                <div className="hidden flex-col gap-1 border-r border-border bg-sidebar p-4 sm:flex">
                  {["Dashboard", "Citas", "Clientes", "Servicios", "Estadísticas"].map((l, i) => (
                    <div
                      key={l}
                      className={`rounded-md px-3 py-2 text-xs font-medium ${i === 0 ? "bg-sidebar-accent text-sidebar-accent-foreground" : "text-sidebar-foreground/70"}`}
                    >
                      {l}
                    </div>
                  ))}
                ...
                <div className="col-span-3 p-6">
                  <div className="grid grid-cols-3 gap-4">
                    {[
                      { l: "Citas hoy", v: "24", c: "text-primary" },
                      { l: "Ingresos", v: "$1.2M", c: "text-success" },
                      { l: "Clientes", v: "148", c: "text-chart-5" },
                    ].map((s) => (
      ...
      <section id="sectores" className="border-t border-border bg-muted/30 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <p className="mt-2 text-center text-muted-foreground">
            Configurable para cualquier profesional independiente o pequeño negocio.
          </p>
          <div className="mt-10 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
            {businesses.map((b) => (
              <div
                key={b.label}
                className="flex flex-col items-center gap-3 rounded-xl border border-border bg-card p-5 text-center transition hover:border-primary/40 hover:shadow-md"
              >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-muted-foreground">
              Diseñado para ser simple incluso si nunca has usado software de gestión.
            </p>
          </div>
            ...
            {[
              {
                ...
                d: "Visualiza, agenda y reprograma citas desde cualquier dispositivo.",
              },
              {
                icon: Users,
                t: "Clientes organizados",
                d: "Historial completo, notas y preferencias de cada cliente.",
              },
              {
                icon: Sparkles,
                t: "Servicios personalizados",
                d: "Configura precios, duración y staff para cada servicio.",
              },
              {
                icon: BarChart3,
                t: "Estadísticas claras",
                d: "Entiende tu negocio: ingresos, ocupación y clientes frecuentes.",
              },
              {
                icon: Clock,
                t: "Horarios flexibles",
                d: "Define tu disponibilidad por día, profesional o sucursal.",
              },
              {
                icon: Smartphone,
                t: "100% responsive",
                d: "Funciona perfecto en tu celular, tablet o computador.",
              },
            ].map((f) => (
              <div
                key={f.t}
      ...
      <section id="precios" className="border-t border-border bg-muted/30 py-20">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
          ...
          <p className="mt-3 text-muted-foreground">
            Sin tarjeta de crédito. Configura tu negocio en menos de 5 minutos.
          </p>
          ...
          <Link
            to="/app"
            className="mt-8 inline-flex items-center gap-2 rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/20 hover:bg-primary/90"
          >
